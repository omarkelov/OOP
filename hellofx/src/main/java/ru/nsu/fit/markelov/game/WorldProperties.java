...
public class WorldProperties {
    ...
    private static final String LEVELS_DIRECTORY = "src/main/resources/ru/nsu/fit/markelov/levels/";
    ...
    public WorldProperties(int level) {
        ...
        try (FileInputStream iStream = new FileInputStream(LEVELS_DIRECTORY + level + LEVEL_IMAGE_EXTENSION)) {
            ...
            JSONObject levelJSONObject = new JSONObject(new String(Files.readAllBytes(Paths.get(LEVELS_DIRECTORY + level + LEVEL_DESCRIPTION_EXTENSION))));

            width = (int) levelImage.getWidth();
            height = (int) levelImage.getHeight();

            goal = levelJSONObject.getInt("goal");
